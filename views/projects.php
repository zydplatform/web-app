...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-4" style="width: 100%;">
        <div class="card">
          <div class="card-header bg-default">News & Updates</div>
          <div class="card-body">Apparently we welcome you to our department website and we
    ...
    <div class="row">
     <div class="col-md-4">
      <div class="card" style="width:400px">
        ...
        <img class="card-img-bottom" src="../images/must7.jpg" alt="Card image" style="width:100%">
      </div>
    </div>
         <div class="col-md-4">
      <div class="card" style="width:400px">
  ...
  <div class="row">
     <div class="col-md-4">
      <div class="card" style="width:400px">
        ...
        <img class="card-img-bottom" src="../images/must12.jpg" alt="Card image" style="width:100%">
      </div>
    </div>
         <div class="col-md-4">
      <div class="card" style="width:400px">
